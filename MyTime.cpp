...
void MyTime::setHour(int hour)
{
    ...
    {
        throw OutOfRangeException ("Hour must be between 0 to 24. Enter again!! ");
    }
}
...
void MyTime::setMinute(int minute)
{
    ...
    {
        throw OutOfRangeException ("Minutes must be between 0 to 59. Enter again!! ");
    }
}
...
void MyTime::setSecond(int second)
{
    ...
    {
        throw OutOfRangeException ("Seconds must be between 0 to 59. Enter again!! ");
    }
}
